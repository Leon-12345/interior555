    ...
    <>
      <motion.li
        ...
        className="relative w-full p-4 py-6 my-4 rounded-xl flex items-center justify-between bg-light
                            ...
                            dark:text-light dark:border-light dark:bg-dark sm:flex-col"
      >
...
const FeaturedArticle = ({ img, link, title, time, summary }) => {
  return (
    <>
      <li
        className="relative col-span-1 w-full p-4 bg-light border border-dark border-solid rounded-2xl
      ...
      >
        ...
        <span className="text-primary text-semibold">{time}</span>
      </li>
    </>
  );
};
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="article with Leon Wei" content="article of Leon" />
      </Head>
      <TransitionEffect />
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout>
          <AnimatedText
            text="Work in Progress.... Just a showcase for my future articles"
