...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      dark: "#1b1b1b",
      light: "#f5f5f5",
      primary: "#D3D3D3", // 240,86,199
      primaryDark: "#5A5A5A", // 80,230,217
    },
    animation: {
    ...
    backgroundImage: {
      ...
      circularLightXs:
        "repeating-radial-gradient(rgba(0,0,0,0.4) 2px,#f5f5f5 4px,#f5f5f5 25px)",
      circularDarkXs:
        "repeating-radial-gradient(rgba(255,255,255,0.5) 2px,#1b1b1b 4px,#1b1b1b 25px)",
    },
  },
  plugins: [],
};
